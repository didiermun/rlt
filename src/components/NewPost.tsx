...
export default function NewPost() {
    ...
    return(
        ...
        <div className='hidden sm:flex w-full md:w-2/3 lg:w-1/2 bg-white rounded-xl  flex-col gap-0 px-2 pt-4 border-darkgray border-2'>
              ...
              <div className='sm:hidden w-full md:w-2/3 lg:w-1/2 rounded-xl flex flex-col gap-0 px-2 pt-4 '>
              <div className="w-full flex justify-start items-center relative">
                <input className="text-xl leading-none bg-white text-left w-full rounded text-gray-600 px-6 py-3 pl-10 outline-none" type="text" placeholder="What do you want to talk about?"/>
                <svg className='absolute left-3 z-10 cursor-pointer' width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M20 2.79503C19.9749 3.35988 19.7395 3.89493 19.34 4.29503L11.225 12.5L6.5 14L8 9.32003L16.16 1.16003C16.4773 0.842905 16.8823 0.627895 17.3227 0.542613C17.7632 0.457331 18.2191 0.505672 18.6319 0.681426C19.0446 0.857181 19.3955 1.15232 19.6392 1.52894C19.883 1.90557 20.0087 2.34647 20 2.79503ZM15.5 15.5C15.5 15.8979 15.342 16.2794 15.0607 16.5607C14.7794 16.842 14.3978 17 14 17H5C4.60218 17 4.22064 16.842 3.93934 16.5607C3.65804 16.2794 3.5 15.8979 3.5 15.5V6.50003C3.5 6.1022 3.65804 5.72067 3.93934 5.43937C4.22064 5.15806 4.60218 5.00003 5 5.00003H9.5V2.00003H5C3.80653 2.00003 2.66193 2.47413 1.81802 3.31805C0.974106 4.16196 0.5 5.30655 0.5 6.50003V15.5C0.5 16.6935 0.974106 17.8381 1.81802 18.682C2.66193 19.5259 3.80653 20 5 20H14C15.1935 20 16.3381 19.5259 17.182 18.682C18.0259 17.8381 18.5 16.6935 18.5 15.5V11H15.5V15.5Z" fill="black" fill-opacity="0.9"/>
                </svg>
